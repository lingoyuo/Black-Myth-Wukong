...
//        GUI.Label(textOutputRect, outputMessage);
    ...
    public void RequestInterstitial()
    {
            ...
            string adUnitId = "unused";
        #elif UNITY_ANDROID
		string adUnitId = "ca-app-pub-6831245005873658/891197332";
		#elif UNITY_IOS
		string adUnitId = "ca-app-pub-6831245005873658/525435052";
        #else
            string adUnitId = "unexpected_platform";
        #endif
    ...
    {
		if (interstitial.IsLoaded() &&  !PlayerPrefs.HasKey ("removeadsKong"))
        {
            interstitial.Show();
